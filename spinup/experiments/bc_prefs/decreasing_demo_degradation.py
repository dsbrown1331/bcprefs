##Tests how performance changes with decreasing numbers of demonstrations
...
if __name__ == '__main__':
    ...
    save_file_name = "{}vs{}".format(good_name,"null")
    ...
    for num_good_demos in range(len(good_demos),0,-1):

        training_demos = []
        training_demos.extend(good_demos[:num_good_demos])
        print("good {} bad {}".format(num_good_demos, 0))
        ...
        results_bad_degredation[:,len(good_demos) - num_good_demos] = ep_returns
