...
from spinup.algos.pytorch.ppo.bc import train_good_bad_bc_policy, evaluate_policy, train_good2_bad_bc_policy
...
if __name__ == '__main__':
    ...
    pickle.dump(results_bad_degredation, open( os.path.join(args.save_path, "good2bad_{}.p".format(save_file_name)), "wb" ))
