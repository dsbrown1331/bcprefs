...
parser.add_argument('--results_file', type=str, default='cartpole20vscartpole2', help='file for plotting that is in results/degredation')

args = parser.parse_args()


bc_results = pickle.load( open( "results/degredation/{}.p".format(args.results_file), "rb" ) )
gb_results = pickle.load( open( "results/degredation/goodbad_{}.p".format(args.results_file), "rb" ) )
g2b_results = pickle.load( open( "results/degredation/good2bad_{}.p".format(args.results_file), "rb" ) )
...
plt.savefig("plotting_scripts/degredation/goodbad_" + args.results_file + ".png")
plt.show()    